...
import com.basedata.PersianMonthsEnum;
...
public class JalaliCalendar extends Calendar {
    ...
    public static YearMonthDate gregorianToJalali(YearMonthDate gregorian) {
        ...
        return new YearMonthDate(jalaliYear, jalaliMonth, jalaliDayNo);
    }
    ...
    public static YearMonthDate jalaliToGregorian(YearMonthDate jalali) {
        ...
        return new YearMonthDate(gregorianYear, gregorianMonth, gregorianDayNo);
    }
    ...
    public static int dayOfWeekInJalali(JalaliDate yearMonthDate) {

        Calendar cal = new JalaliCalendar(yearMonthDate.getYear(), yearMonthDate.getMonth(), yearMonthDate.getDate());
        return cal.get(DAY_OF_WEEK);

    }

//    public static String nameOfDayOfWeekInJalali(int day) {
//        return switch (day){
//            case 1 -> PersianDaysEnum.MONDAY.toString();
//            case 2 -> PersianDaysEnum.TUESDAY.toString();
//            case 3 -> PersianDaysEnum.WEDNESDAY.toString();
//            case 4 -> PersianDaysEnum.THURSDAY.toString();
//            case 5 -> PersianDaysEnum.FRIDAY.toString();
//            case 6 -> PersianDaysEnum.SATURDAY.toString();
//            case 7 -> PersianDaysEnum.SUNDAY.toString();
//            default -> "UNDEFINED";
//        };
//    }

//    public static String nameOfMonthOfWeekInJalali(String month) {
//        return switch (month){
//            case "01" -> PersianMonthsEnum.FARVARDIN.toString();
//            case "02" -> PersianMonthsEnum.ORDIBEHESHT.toString();
//            case "03" -> PersianMonthsEnum.KHORDAD.toString();
//            case "04" -> PersianMonthsEnum.TIR.toString();
//            case "05" -> PersianMonthsEnum.MORDAD.toString();
//            case "06" -> PersianMonthsEnum.SHAHRIVAR.toString();
//            case "07" -> PersianMonthsEnum.MEHR.toString();
//            case "08" -> PersianMonthsEnum.ABAN.toString();
//            case "09" -> PersianMonthsEnum.AZAR.toString();
//            case "10" -> PersianMonthsEnum.DEY.toString();
//            case "11" -> PersianMonthsEnum.BAHMAN.toString();
//            case "12" -> PersianMonthsEnum.ESFAND.toString();
//            default -> "UNDEFINED";
//        };
//    }
